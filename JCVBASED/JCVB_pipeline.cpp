...
namespace Digestion {
	...
	Pipeline::~Pipeline() {
		vkDestroyShaderModule(jcvbDevice.device(), vertShaderModule, nullptr);
		vkDestroyShaderModule(jcvbDevice.device(), fragShaderModule, nullptr);
		vkDestroyPipeline(jcvbDevice.device(), graphicsPipeline, nullptr);
	}
	...
	void Pipeline::createGraphicsPipeline(const std::string& vertFilepath, const std::string& fragFilepath, const PipelineConfigInfo& configInfo) {
		...
		if (vkCreateGraphicsPipelines(jcvbDevice.device(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS) {
	...
	void Pipeline::createShaderModule(const std::vector<char>& code, VkShaderModule* shaderModule) {
		...
		if (vkCreateShaderModule(jcvbDevice.device(), &createInfo, nullptr, shaderModule) != VK_SUCCESS) {
